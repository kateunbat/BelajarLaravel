...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
         <form action="{{url('siswa/add')}}" class="form-horizontal"  method="POST" enctype="multipart/form-data">
           {{csrf_field() }}
           ...
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <input type="text" name="nis" class="form-control" placeholder="Masukan NIS" value="{{@$data->nis}}" />
             </div>
           </div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="col-sm-10">
               <input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Lengkap" value="{{@$data->alamat}}" />
             </div>
           </div>
